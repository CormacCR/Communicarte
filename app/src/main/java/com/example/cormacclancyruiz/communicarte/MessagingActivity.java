...
public class MessagingActivity extends BaseActivity implements MessageClientListener {
    ...
    private String roomKey, username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = usertype==ATTENDEE?getIntent().getStringExtra("USERNAME"):roomKey;
    ...
    private void sendMessage() {
        if(usertype==ATTENDEE) {
            ...
            Toast.makeText(this, "Messaging disabled for Speaker accounts.", Toast.LENGTH_LONG).show();
        }
    }
